...
const CompletedTask = () => {
  return (
    <div className="flex-shrink-0 bg-green-400 h-full w-100 rounded-4xl">
    {" "}
    ...
    <div className='flex justify-center'>
        <button className='flex bg-red-500 py-1 px-2 rounded font-bold mt-7'>Task Completed</button>
    </div>
  </div>
  )
}

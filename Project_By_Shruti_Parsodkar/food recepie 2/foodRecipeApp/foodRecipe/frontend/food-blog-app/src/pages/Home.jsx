...
import foodRecipe from '../assets/recipecoverpage.jpg'
    ...
    return (
        <>
            <section className='home'>
                <div className='left'>
                    <h1>Food Recipe</h1>
                    <h5>It is a long established fact that a reader will be distracted by the readable content of a page when looking at its layout. The point of using Lorem Ipsum is that it has a more-or-less normal distribution of letters, as opposed to using 'Content here, content here', making it look like readable English.    "Hungry for creativity? Try our Spicy Garlic Noodles tonight!"

"Your saved ‘Paneer Tikka’ recipe is calling your name! �"

*"New Recipe Alert: 5-Ingredient Chocolate Mug Cake!"*</h5>
